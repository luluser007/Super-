...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Rasel_CH
	    time.sleep(2)
            loop = 'false'
        else:
...
def pilih():
	...
	if unikers =="":
		...
		os.system('clear')
		print logo
		print " \033[1;36;40m◄══════════════════Asim-Pardasi══════════════════►\n"
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ..Rasel CH Creations.. \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Instagram
              \033[1;91masimch617"""
